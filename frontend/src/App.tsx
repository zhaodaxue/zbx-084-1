  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-slate-100">
      <header className="bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900 text-white shadow-xl">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-slate-400 text-sm">浊度与 pH 异常分析 · 连续异常集中段复盘</p>
              </div>
            </div>
        ...
        {stations.length > 0 && (
          <div className="max-w-[1600px] mx-auto px-6 py-3 bg-black/20">
      ...
      <main className="max-w-[1600px] mx-auto px-6 py-8">
        <div className="grid grid-cols-1 xl:grid-cols-[320px_1fr_340px] gap-6">
          ...
          <div className="xl:col-span-1 xl:min-h-[700px]">
            <AnomalySidebar />
          </div>
        </div>
      </main>
